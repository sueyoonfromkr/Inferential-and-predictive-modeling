...
# Based on the frequency, we decided to remove all the observation that voted by more than 50% of the results of Multivariate outlier analysis
...
impListFin <- complete(miceOutFin, "all")
